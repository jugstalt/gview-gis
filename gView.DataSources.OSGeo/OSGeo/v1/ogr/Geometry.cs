...
public int ExportToWkb( byte[] buffer, wkbByteOrder byte_order ) {
  ...
  public int Transform(OSGeo_v1.OSR.CoordinateTransformation trans) {
    int ret = OgrPINVOKE.Geometry_Transform(swigCPtr, OSGeo_v1.OSR.CoordinateTransformation.getCPtr(trans));
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
