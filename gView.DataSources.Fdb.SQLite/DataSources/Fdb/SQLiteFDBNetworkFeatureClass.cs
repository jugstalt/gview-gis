...
{
    public class SQLiteFDBNetworkFeatureClass : IFeatureClass, INetworkFeatureClass
    {
        ...
        private SQLiteFDBNetworkFeatureClass() { }

        async static public Task<SQLiteFDBNetworkFeatureClass> Create(SQLiteFDB fdb, IDataset dataset, string name, GeometryDef geomDef)
        {
            var fc = new SQLiteFDBNetworkFeatureClass();
            fc._fdb = fdb;
        ...
        private class SQLiteFDBGraphTableAdapter : IGraphTableAdapter
        {
            private string _name, _connString;
            private SQLiteFDBNetworkFeatureClass _nfc;
        ...
        {
            return new SQLiteFDBGraphTableAdapter(_fdb, this);
        }
        ...
        async public Task<IFeature> GetNodeFeatureAttributes(int nodeId, string[] attributes)
        {
            try
            {
                ...
                string fcName = await _fdb.GetFeatureClassName(Convert.ToInt32(feature["FCID"]));
