...
[RegisterPlugIn("5a5afdc1-acbb-499a-8c7b-606a3e95ee40")]
public class GeoPackageFeatureClassExplorerObject :
                    ExplorerObjectCls<GeoPackageExplorerObject, IFeatureClass>,
                    ...
                    IPlugInDependencies
{
    ...
    public GeoPackageFeatureClassExplorerObject() : base() { }

    public GeoPackageFeatureClassExplorerObject(GeoPackageExplorerObject parent, IDatasetElement element)
        : base(parent, 1)
    {
    ...
    async public Task<IExplorerObject?> CreateInstanceByFullName(string FullName, ISerializableExplorerObjectCache? cache)
    {
        ...
        var dsObject = await new GeoPackageExplorerObject()
                                    .CreateInstanceByFullName(dsName, cache) as GeoPackageExplorerObject;
        if (dsObject == null)
        {
            return null;
        }
    ...
    public bool HasUnsolvedDependencies() => GeoPackageDataset.HasUnsolvedDependenciesStatic;
