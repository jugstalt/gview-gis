	...
	*/
    internal class selectionGeometry
    {
        ...
        public bool isValid
        {
            get
            {
                if (GeometryType == GeometryType.Point && m_points.Count > 0)
                {
                    return true;
                }

                if (GeometryType == GeometryType.Polyline && m_points.Count > 1)
                {
                    return true;
                }

                if (GeometryType == GeometryType.Polygon && m_points.Count > 2)
                {
                    return true;
                }

                if (GeometryType == GeometryType.Envelope && m_points.Count == 2)
                {
                    return true;
                }
