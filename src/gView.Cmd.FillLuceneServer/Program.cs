    ...
    class Program
    {
        ...
        async static Task<int> Main(string[] args)
        {
            try
            {
                ...
                //gView.Framework.Common.SystemVariables.CustomApplicationDirectory =
                //    System.IO.Path.GetDirectoryName(Assembly.GetEntryAssembly().Location);

                Console.WriteLine("Environment");

                Console.WriteLine("Working Directory: " + SystemVariables.StartupDirectory);
                Console.WriteLine("64Bit=" + Wow.Is64BitProcess);
