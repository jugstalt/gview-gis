...
public delegate int GDALProgressFuncDelegate(double Complete, IntPtr Message, IntPtr Data);
  public static Geometry CreateGeometryFromWkb(uint len, IntPtr bin_string, OSGeo_v3.OSR.SpatialReference reference) {
    IntPtr cPtr = OgrPINVOKE.CreateGeometryFromWkb(len, bin_string, OSGeo_v3.OSR.SpatialReference.getCPtr(reference));
