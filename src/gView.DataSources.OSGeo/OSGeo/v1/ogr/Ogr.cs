...
namespace OSGeo_v1.OGR
{
    ...
    public class Ogr
    {
        ...
        public static Geometry CreateGeometryFromWkb(int len, IntPtr bin_string, OSGeo_v1.OSR.SpatialReference reference)
        {
            IntPtr cPtr = OgrPINVOKE.CreateGeometryFromWkb(len, bin_string, OSGeo_v1.OSR.SpatialReference.getCPtr(reference));
