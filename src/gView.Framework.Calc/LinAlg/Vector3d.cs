...
namespace gView.Framework.Calc.LinAlg
{
    public class Vector3d
    {
        ...
        public Vector3d(double[] v)
        {
            ...
            for (int i = 0; i < System.Math.Min(v.Length, 3); i++)
            {
                _v[i] = v[i];
            }
        }
    ...
    public class Vector2d
    {
        ...
        public Vector2d(double[] v)
        {
            ...
            for (int i = 0; i < System.Math.Min(v.Length, 2); i++)
            {
                _v[i] = v[i];
            }
        }
        ...
        public double Angle
        {
            get
            {
                double angle = System.Math.Atan2(_v[1], _v[0]);
                if (angle < 0.0)
                {
