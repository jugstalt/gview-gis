...
{
    /// <summary>
    /// Shared lifecycle and row materialization for the SQL Server FDB feature cursors. Each
    ...
    /// </summary>
    internal abstract class SqlFeatureCursorBase : FeatureCursor
    {
        ...
        protected SqlFeatureCursorBase(IGeometryDef geomDef, ISpatialReference toSRef, IDatumTransformations datumTransformations)
            : base(geomDef,
        ...
        /// proprietary blob from <c>FDB_SHAPE</c>; the native cursor aliases
        /// <c>FDB_SHAPE.STAsBinary()</c> to <c>temp_geometry</c>.
        /// </summary>
