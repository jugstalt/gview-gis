...
namespace gView.Framework.Geometry
{
    ...
    public static class Proj9Wrapper
    {
        // proj_create_crs_to_crs:
        //   Creates a transformation between two coordinate systems 
        //   (e.g., "EPSG:4326" -> "EPSG:3857").
        [DllImport("proj_9_4.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("proj_9_4.dll", CallingConvention = CallingConvention.Cdecl)]
    ...
    public sealed class GeometricTransformerProj9Nativ : IGeometricTransformer, IDisposable
    {
        ...
        public GeometricTransformerProj9Nativ(IDatumTransformations datumTransformations)
        {
        ...
        public object Transform2D(object geometry)
        {
            ...
            if (_pj == IntPtr.Zero)
            {
                _pj = Proj9Wrapper.proj_create_crs_to_crs(_ctx,
        ...
        public object InvTransform2D(object geometry)
        {
            ...
            {
                _pjInv = Proj9Wrapper.proj_create_crs_to_crs(_ctx,
                    AllParametersString(_toSRef),
                    AllParametersString(_fromSRef),
                    IntPtr.Zero);
        ...
        private object Transform2D_(object geometry, IntPtr pj, bool fromProjective, bool toProjektive)
        {
            if (geometry is IPointCollection)
            {
                ...
                //    Proj9Wrapper.proj_trans_array(_pj, PJ_DIRECTION.PJ_FWD, (ulong)pointCount, buffer);
                ...
                Proj9Wrapper.proj_trans_array(_pj, PJ_DIRECTION.PJ_FWD, (ulong)coordArray.Length, coordArray);

                int errorNo = Proj9Wrapper.proj_errno(_pj);
                if (errorNo != 0)
                {
        ...
        public void Release()
        {
            //if (_pj != IntPtr.Zero)
            //{
            //    Proj9Wrapper.proj_destroy(_pj);
            //    _pj = IntPtr.Zero;
            //}

            //if (_pjInv != IntPtr.Zero)
            //{
            //    Proj9Wrapper.proj_destroy(_pjInv);
            //    _pjInv = IntPtr.Zero;
            //}

            //if (_ctx != IntPtr.Zero)
            //{
            //    Proj9Wrapper.proj_context_destroy(_ctx);
            //    _ctx = IntPtr.Zero;
            //}
        }
