...
#if(DEBUG)
                //gView.Framework.Common.Logger.LogDebug("Start ArcXML DownloadImage");
#endif
                IBitmap bitmap = null;
                if (outputNode != null)
                {
#if(DEBUG)
                    Logger.LogDebug("Start ArcXML DownloadImage");
#endif
                    bitmap = await WebFunctions.DownloadImage(_dataset._http, outputNode/*_dataset._connector.Proxy*/);
#if(DEBUG)
                    Logger.LogDebug("ArcXML DownloadImage Finished");
#endif
                }
                else
                {
...
#if(DEBUG)
                //gView.Framework.Common.Logger.LogDebug("ArcXML DownloadImage Finished");
#endif
