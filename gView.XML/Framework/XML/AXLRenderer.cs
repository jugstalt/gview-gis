...
namespace gView.Framework.XML
{
    ...
    internal class AXLRenderer
    {
        ...
        protected void modifyRenderer(XmlNodeList nl, double opacity, ref bool modified)
        {
            foreach (XmlNode xn in nl)
            {
                ...
                if (xn.HasChildNodes)
                {
                    modifyRenderer(xn.ChildNodes, opacity, ref modified);
                }
            }
        }
        ...
        {
            if (m_uselabel == false || m_labelrenderer == "")
            {
                return m_renderer;
            }
    ...
    internal class SimpleAXLLabelRenderer
    {
        ...
        public string borderstyle
        {
            get
            {
                if (getTextAttribute("shadow") != "")
                {
                    return "shadow";
                }

                if (getTextAttribute("glowing") != "")
                {
                    return "glowing";
                }

                if (getTextAttribute("blockout") != "")
                {
                    return "blockout";
                }
        ...
        public string bordercolor
        {
            get
            {
                if (getTextAttribute("shadow") != "")
                {
                    return getTextAttribute("shadow");
                }

                if (getTextAttribute("glowing") != "")
                {
                    return getTextAttribute("glowing");
                }

                if (getTextAttribute("blockout") != "")
                {
                    return getTextAttribute("blockout");
                }
            ...
            set
            {
                ...
                {
                    removeTextAttribute("shadow");
                }

                if (m_borderstyle != "glowing")
                {
                    removeTextAttribute("glowing");
                }

                if (m_borderstyle != "blockout")
                {
                    removeTextAttribute("blockout");
                }

                if (m_borderstyle != "node")
                {
                    setTextAttribute(m_borderstyle, value);
                }
            }
        }
