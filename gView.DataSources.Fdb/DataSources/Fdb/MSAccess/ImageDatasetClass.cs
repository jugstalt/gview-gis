...
//{
//    public class AccessFDBImageCatalogClass : IRasterCatalogClass, IParentRasterLayer, IFileSystemDependent, IFileWatchingDirectories, IRefreshable, IPointIdentify, IMulitPointIdentify, IGridClass, IPersistable
//    {
...
//        internal AccessFDBImageCatalogClass()
//        {
//        }
...
//        {
//            if (!(obj is AccessFDBImageCatalogClass)) return;

//            AccessFDBImageCatalogClass ic = (AccessFDBImageCatalogClass)obj;
...
//        private AccessFDBImageCatalogClass _layer;
//        private IEnvelope _dispEnvelope = null;
//        private double _pix = 1.0;

//        public RasterLayerCursor(AccessFDBImageCatalogClass layer, IFeatureCursor cursor)
//        {
//            _layer = layer;
//            _cursor = cursor;
//        }
//        public RasterLayerCursor(AccessFDBImageCatalogClass layer, IFeatureCursor cursor, IEnvelope dispEnvelope, double pix)
//            : this(layer, cursor)
//        {
...
//                        if ((bool)feature["MANAGED"] && _layer._imageSpaceType == AccessFDBImageCatalogClass.ImageSpaceType.Database)
//                        {
...
//                                {
//                                    AccessFDBImageDatasetImageClass rClass = new AccessFDBImageDatasetImageClass(_layer._fdb, _layer._dsname, (int)row["ID"], polygon);
...
//                            }
//                        }
//                        else if ((bool)feature["MANAGED"] && _layer._imageSpaceType == AccessFDBImageCatalogClass.ImageSpaceType.FileSystem)
//                        {
...
//    internal class AccessFDBImageDatasetImageClass : IRasterClass
//    {
//        AccessFDB _fdb;
//        private int _ID;
