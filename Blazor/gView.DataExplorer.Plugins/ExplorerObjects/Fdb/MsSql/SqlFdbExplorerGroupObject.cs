                                         ...
                                         IDatabasesExplorerGroupObject
{
    ...
    public string Icon=> "basic:database-edit";

    #endregion

    #region IExplorerObject Members

    public string Name => "MS SQL Server Feature Database Connections";
                                    ...
                                    IExplorerObjectCreatable
{
    ...
    public Task<IExplorerObject?> CreateExplorerObject(IApplicationScope appScope, IExplorerObject parentExObject)
    {
        return Task.FromResult<IExplorerObject?>(null);
                                         ...
                                         IExplorerObjectCreatable
{
    ...
    public Task<object?> GetInstanceAsync() =>.FromResult<object?>(null);
