...
namespace gView.Framework.Symbology.UI.Controls
{
    ...
    public partial class OfficeColorPicker : UserControl
    {
        ...
        /// </summary>
        public int PreferredHeight = 142;
        /// <summary>
       ...
       DefaultValue(typeof(Color), "System.Drawing.Color.Black")]
        ...
        private bool _allowNoColor = false;
        public bool AllowNoColor
        {
            get { return _allowNoColor; }
            set
            {
                _allowNoColor = value;
                PreferredHeight = 142 + ((value) ? 24 : 0);
            }
        }
        #endregion
        ...
        /// </summary>
        private Rectangle[] buttons = new Rectangle[43];
        /// <summary>
        ...
        public OfficeColorPicker(IWindowsFormsEditorService wfes, Color startingColor)
            : this(startingColor)
        {
            _wfes = wfes;
        }
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
            ...
            for (int recIndex = 0; recIndex < buttons.Length; recIndex++)
            {
                if (buttons[recIndex].Contains(e.Location))
                {
                    ...
                    else if (_currentSelected == 41)
                    {
                        Color = OpenTransparencyDialog();
                    }
                    else if (_currentSelected == 42)
                    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (_allowNoColor)
            {
                PaintNoColorButton(e.Graphics, x, y);
                y += 23;
            }
            ...
            y += 2;
            PaintSeperator(e.Graphics, x, y);
            y += 2;
            PaintMoreColorsButton(e.Graphics, x, y);
            y += 23;
            PaintTransparencyButton(e.Graphics, x, y);
            //base.OnPaint(e);
        }
        /// <summary>
        ...
        /// <param name="x"></param>
        /// <param name="y"></param>
        protected void PaintMoreColorsButton(System.Drawing.Graphics graphics, int x, int y)
        {
        ...
        protected void PaintTransparencyButton(System.Drawing.Graphics graphics, int x, int y)
        {
            ...
            format.LineAlignment = StringAlignment.Center;
            Font buttonFont = new Font("Arial", 8);
            bool selected = _currentSelected == 41;
            bool hotTrack = _currentHotTrack == 41;
            ...
            //  Draw the string itself using the rectangle, font and format specified.
            graphics.DrawString("Transparency...", buttonFont, Brushes.Black, buttonRec, format);
            format.Dispose();
            buttonFont.Dispose();
            buttons[41] = buttonRec;
        }
        protected void PaintNoColorButton(System.Drawing.Graphics graphics, int x, int y)
        {
            // The rectangle for the 'More Colors' button
            Rectangle buttonRec = new Rectangle(x, y, 8 * 18 - 1, 22);
            // The text will be displayed in the center of the rectangle
            ...
            format.LineAlignment = StringAlignment.Center;
            Font buttonFont = new Font("Arial", 8);
            bool selected = _currentSelected == 42;
            bool hotTrack = _currentHotTrack == 42;
            ...
            //  Draw the string itself using the rectangle, font and format specified.
            graphics.DrawString("No Color...", buttonFont, Brushes.Black, buttonRec, format);
            format.Dispose();
            buttonFont.Dispose();
            buttons[42] = buttonRec;
        }
