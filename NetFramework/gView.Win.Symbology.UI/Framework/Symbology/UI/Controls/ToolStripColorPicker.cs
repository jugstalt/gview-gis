...
namespace gView.Framework.Symbology.UI.Controls
{
    ...
    public class ToolStripColorPicker : ToolStripDropDownButton
    {
        ...
        {
            get { return _colorPicker.AllowNoColor; }
            set { _colorPicker.AllowNoColor = value; }
        }
        #endregion
        ...
        public ToolStripColorPicker(Color startingColor, Control parent)
            : this(startingColor)
        {
        ...
        protected override void OnClick(EventArgs e)
        {
            ...
            //if (startPoint.X + _colorPicker.Width > screenW)
            //{
            //    startPoint.X -= _colorPicker.Width - this.Width - 5;
            //}
            //if (startPoint.Y + _colorPicker.Height > screenH)
            //{
            //    startPoint.Y -= this.Height + _colorPicker.Height + 5;
            //}
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            if (e.X > this.Width - 12)
            {
                ...
                if (startPoint.Y + _colorPicker.Height > screenH)
                {
                    startPoint.Y -= this.Height + _colorPicker.Height + 6;
                }
        ...
        private void PaintUnderLine(System.Drawing.Graphics g)
        {
        ...
        /// <param name="bounds"></param>
        /// <returns></returns>
        private Size PaintUnderLineImage(System.Drawing.Graphics g)
        {
        ...
        /// <param name="bounds"></param>
        private void PaintUnderLineText(System.Drawing.Graphics g, Size imageSize)
        {
